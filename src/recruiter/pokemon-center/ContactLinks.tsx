        ...
        return (
          <li key={channel.key}>
            <a
              ...
              className="flex items-center justify-between rounded-md border border-edge px-3 py-2.5 font-mono text-sm text-ink transition-colors hover:border-poke-red focus:outline-none focus-visible:ring-2 focus-visible:ring-poke-red"
            >
